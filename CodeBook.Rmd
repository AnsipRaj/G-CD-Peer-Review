...
subjectname- This variable recorded the subject that the observations corresponded to.A total of 30 subjects numbered from 1-30 were recroded. The variable has no units. It is merely a number assigned to a person. 

subjectact- This variable recorded the the activity that teh subject undertook during the experiment.6 different activities were recorded. These are descriptive, character variables
