...
The variables in the final tidy data set- consist of all the features described the mean and standard devations of observations that were part of the experiment on wearable technology, and two additional vairables indtroduced during analysis. The two new variables are- 
...
These variables were present in the original UCI HAR Dataset. The Variables are the mean and standard deviation measures for the following in the original dataset.  
tBodyAcc XYZ
tGravityAcc XYZ
tBodyAccJerk XYZ
tBodyGyro XYZ
...
A total of 68 variables were present in the first dataset 
